...
public class YearlyItemReport {
	...
	List<TempSubCatList> dataList=null;
	...
	public List<TempSubCatList> getDataList() {
		return dataList;
	}

	public void setDataList(List<TempSubCatList> dataList) {
		this.dataList = dataList;
	}

	@Override
	public String toString() {
		return "YearlyItemReport [monthId=" + monthId + ", yearId=" + yearId + ", dateStr=" + dateStr
